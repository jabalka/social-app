...
export default {
  ...
  safelist: [
    ...
    'sm:max-w-sm', 'sm:max-w-md', 'sm:max-w-lg', 'sm:max-w-xl', 'sm:max-w-2xl', 'sm:max-w-3xl', 'sm:max-w-4xl', 'sm:max-w-5xl',
    'md:max-w-sm', 'md:max-w-md', 'md:max-w-lg', 'md:max-w-xl', 'md:max-w-2xl', 'md:max-w-3xl', 'md:max-w-4xl', 'md:max-w-5xl',
    'lg:max-w-sm', 'lg:max-w-md', 'lg:max-w-lg', 'lg:max-w-xl', 'lg:max-w-2xl', 'lg:max-w-3xl', 'lg:max-w-4xl', 'lg:max-w-5xl',
  ],
  theme: {
    extend: {
      colors: {
      ...
      keyframes: {
        ...
        snakeBorderGreen1sLight: {
          "0%": {
            // boxShadow: "[inset] x-offset y-offset blur-radius spread-radius color"
            boxShadow: "inset 0 0 0 2px #0ccd08, 0 0 8px 2px #0ccd08",
            //             Top-left: `0 0`
            //             Top-right: `100% 0`
            //             Bottom-right: `100% 100%`
            //             Bottom-left: `0 100%`
      ...
      animation: {
        ...
        snakeBorderGreen1sLight: "snakeBorderGreen1sLight 1s ease-in-out infinite",
