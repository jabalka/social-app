...
const ThemeToggle: React.FC<Props> = ({ theme, onClick, className }) => {
  ...
  return (
    <>
    <div className={`${className} w-[49px] group relative inline-flex overflow-hidden rounded-full p-[4px]`}>
      <Button
        type="button"
      ...
      >
        ...
        <span
            key={animationKey}
            className="group-hover:animate-snakeBorderHover pointer-events-none absolute -inset-[4px] rounded-full"
          />
      </Button>
    </div>
    </>
